...
const Features = () => (
    <section className='bg-black pb-52'>
        ...
        <div className="grid h-[135vh] w-full grid-cols-1 grid-rows-4 gap-7 md:grid-cols-2 md:grid-rows-3">
            ...
            <BentoTilt className="bento-tilt_2">
                <div className="flex size-full flex-col justify-between bg-violet-300 p-5">
                    <h1 className="bento-title special-font max-w-64 text-black">M<b>o</b>re C<b>o</b>ming S<b>o</b><b>o</b>n!</h1>
